  ...
  return (
    <div style={{margin:"100px", backgroundColor:"#4399e1", padding:"100px"}}>
      ...
      <form onSubmit={handleRegister}>
        <input style={{padding:"10px", margin:"20px", border:"1px solid black", width:"250px", borderRadius:"5px"}}
         type="text" placeholder="Username" value={username} onChange={(e) => setUsername(e.target.value)} required /><br></br>
        <input style={{padding:"10px", margin:"20px", border:"1px solid black", width:"250px", borderRadius:"5px"}} 
